...
cleos push action ebonhavencom upsertstats '["ebonhavencom", 1, 200, 12, [18, 12], [18, 12], [7, 5, 10, 8, 5], [4, 2], [4, 2], [2, 1, 3, 2, 1]]' -p ebonhavencom@active
cleos push action ebonhavencom upsertstats '["ebonhavencom", 2, 180, 10, [20, 10], [15, 15], [5, 10, 7, 5, 8], [5, 1], [5, 1], [1, 3, 2, 1, 2]]' -p ebonhavencom@active
cleos push action ebonhavencom upsertstats '["ebonhavencom", 3, 160, 8, [12, 18], [18, 12], [4, 8, 8, 8, 7], [3, 3], [3, 3], [1, 2, 2, 2, 2]]' -p ebonhavencom@active
cleos push action ebonhavencom upsertstats '["ebonhavencom", 4, 140, 8, [10, 22], [10, 20], [5, 8, 7, 11, 4], [1, 5], [1, 5], [1, 2, 2, 3, 1]]' -p ebonhavencom@active
cleos push action ebonhavencom upsertstats '["ebonhavencom", 5, 220, 14, [16, 14], [20, 10], [9, 4, 6, 9, 7], [4, 2], [5, 1], [3, 2, 1, 2, 1]]' -p ebonhavencom@active

# echo "=== create tokens ==="
# cleos push action ebonhaven tokencreate '["ebonhaven", "1000000000.0000 EBON"]' -p ebonhavencom@active

echo "=== create base account ==="
cleos push action ebonhaven newaccount '["ebonhavencom"]' -p ebonhaven@active
